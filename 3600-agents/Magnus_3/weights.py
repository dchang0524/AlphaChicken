...
class HeuristicWeights:
    ...
    W_VORONOI_EGG = 2 # was 0.8. Value expansion more
    ...
    W_TRAP_CONST = 0.2 # was 0.8
    TRAP_WEIGHT = 1.0

    # 4. Closeness to Egg
    # Bonus for being close to an egg if min_dist >= depth/2
    W_EGG_DIST_PENALTY = 0.1

    # 5. Blocks (Safe Eggs)
    # Weight for unclaimed eggs where opponent can't reach
    # value "safe" eggs less than "contested" ones to encourage speed
    W_SAFE_EGG = 0.8
